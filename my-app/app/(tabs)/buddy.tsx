...
const styles = StyleSheet.create({
  ...
  messageText: { fontFamily: 'OpenDyslexic', fontSize: 16, lineHeight: 22 },
  userText: { color: '#FFFFFF', fontFamily: 'OpenDyslexic-Bold' },
  inputWrapper: { paddingHorizontal: 15, paddingTop: 10, borderTopWidth: 1, borderTopColor: 'transparent' },
  inputContainer: { flexDirection: 'row', alignItems: 'center', borderRadius: 25, paddingHorizontal: 12, paddingVertical: 5 },
  input: { flex: 1, fontFamily: 'OpenDyslexic', fontSize: 16, paddingHorizontal: 10, paddingVertical: 8 },
  sendButton: { width: 35, height: 35, backgroundColor: '#FF6B6B', borderRadius: 18, justifyContent: 'center', alignItems: 'center', marginLeft: 8 },
});